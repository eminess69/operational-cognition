# Task Comparison: Constrained Operational Planning Under Stale Assumptions
...
| seasoned | 43 | +9 | `inside_voice_consults/task_004_seasoned_response.json`; MCP-seasoned refs visible |
| ablated | 39 | +5 | `inside_voice_consults/task_004_ablated_response.json`; candidate-family refs suppressed |
