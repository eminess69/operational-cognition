# Task Comparison: Conflicting Architecture Migration Plan
...
| --- | ---: | ---: | --- |
| baseline | 33 | 0 | visible-only solution; no consult response |
| seasoned | 42 | +9 | `inside_voice_consults/task_002_seasoned_response.json`; MCP-seasoned refs visible |
| ablated | 38 | +5 | `inside_voice_consults/task_002_ablated_response.json`; candidate-family refs suppressed |
