...
Visible-only replay is restricted to visible transcript order and visible summaries. Pond-backed replay uses full-lineage refs, runtime hashes, pressure rankings, contradiction refs, authority refs, recovery refs, temporal refs, and MCP-seasoned candidate refs from `scenario_002_pond_response.json`.
