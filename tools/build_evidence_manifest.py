...
PROOF_004_SOURCES: list[dict[str, Any]] = [
    {
        "id": "openclaw-doc-compaction",
        "system": "OpenClaw",
        "type": "doc",
        ...
        "fetch_url": "https://docs.openclaw.ai/concepts/compaction.md",
        "capture_method": "markdown",
        "tags": ["compression-boundary", "memory-reconstruction", "recovery-loop", "replay-provenance"],
        "notes": "Public documentation describes compaction behavior, preserved history surfaces, and recovery interactions relevant to operational failure reconstruction.",
    },
    {
        "id": "openclaw-doc-memory-overview",
        "system": "OpenClaw",
        ...
        "fetch_url": "https://docs.openclaw.ai/concepts/memory.md",
        "capture_method": "markdown",
        "tags": ["intent-reconstruction", "memory-reconstruction"],
        "notes": "Public documentation describes memory files, recall surfaces, and memory boundaries that may affect causal reconstruction.",
    },
    {
        "id": "openclaw-doc-trajectory-bundles",
        "system": "OpenClaw",
        ...
        "fetch_url": "https://docs.openclaw.ai/tools/trajectory.md",
        "capture_method": "markdown",
        "tags": ["causal-replay", "replay-provenance", "tool-action-reconstruction", "trajectory-bundle"],
        "notes": "Public documentation describes trajectory export surfaces relevant to transcript, tool/action, provenance, and causal replay adequacy review.",
    },
    {
        "id": "openhands-doc-agent-server-architecture",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/arch/agent-server.md",
        "capture_method": "markdown",
        "tags": ["environment-reconstruction", "runtime-provenance"],
        "notes": "Public architecture documentation describes remote execution and workspace surfaces relevant to environment provenance reconstruction.",
    },
    {
        "id": "openhands-doc-browser-session-recording",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/guides/browser-session-recording.md",
        "capture_method": "markdown",
        "tags": ["browser-session-replay", "visible-replay"],
        "notes": "Public documentation describes browser recording and replay support used as evidence for visible replay boundaries.",
    },
    {
        "id": "openhands-doc-condenser-architecture",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/arch/condenser.md",
        "capture_method": "markdown",
        "tags": ["condensation-boundary", "omitted-range", "replay-provenance"],
        "notes": "Public architecture documentation describes history condensation, summaries, and omitted event references relevant to reconstruction gaps.",
    },
    {
        "id": "openhands-doc-conversation-architecture",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/arch/conversation.md",
        "capture_method": "markdown",
        "tags": ["event-reconstruction", "session-state", "temporal-reconstruction"],
        "notes": "Public architecture documentation describes conversation state, event logs, persistence, and execution status relevant to causal reconstruction.",
    },
    {
        "id": "openhands-doc-events-architecture",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/arch/events.md",
        "capture_method": "markdown",
        "tags": ["causal-replay", "event-reconstruction", "tool-action-reconstruction"],
        "notes": "Public architecture documentation describes typed events and action/observation flows relevant to operational lineage reconstruction.",
    },
    {
        "id": "shared-rrweb-readme",
        "system": "Shared",
        ...
        "capture_method": "markdown",
        "tags": ["browser-session-replay", "visible-replay"],
        "notes": "Public upstream replay library documentation is included only as shared context for browser replay semantics.",
    },
]

PROOF_005_SOURCES: list[dict[str, Any]] = [
    {
        "id": "openclaw-doc-compaction",
        "system": "OpenClaw",
        "type": "doc",
        ...
        "fetch_url": "https://docs.openclaw.ai/concepts/compaction.md",
        "capture_method": "markdown",
        "tags": ["contradiction-retention", "summary-flattening", "uncertainty-retention"],
        "notes": "Public documentation describes compaction behavior and summary surfaces relevant to contradiction and uncertainty survivability review.",
    },
    {
        "id": "openclaw-doc-memory-overview",
        "system": "OpenClaw",
        ...
        "fetch_url": "https://docs.openclaw.ai/concepts/memory.md",
        "capture_method": "markdown",
        "tags": ["memory-contradiction", "source-authority", "stale-assumption"],
        "notes": "Public documentation describes memory files, recall surfaces, and memory boundaries relevant to stale assumptions and memory contradiction drift.",
    },
    {
        "id": "openclaw-doc-trajectory-bundles",
        "system": "OpenClaw",
        ...
        "fetch_url": "https://docs.openclaw.ai/tools/trajectory.md",
        "capture_method": "markdown",
        "tags": ["contradiction-replay", "replay-ambiguity", "temporal-contradiction"],
        "notes": "Public documentation describes trajectory export surfaces relevant to replay ambiguity, temporal ordering, and contradiction lineage review.",
    },
    {
        "id": "openhands-doc-agent-server-architecture",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/arch/agent-server.md",
        "capture_method": "markdown",
        "tags": ["operational-truth", "runtime-provenance"],
        "notes": "Public architecture documentation describes remote execution and workspace surfaces relevant to operational truth reconstruction boundaries.",
    },
    {
        "id": "openhands-doc-browser-session-recording",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/guides/browser-session-recording.md",
        "capture_method": "markdown",
        "tags": ["replay-ambiguity", "visible-replay"],
        "notes": "Public documentation describes browser recording and replay support used as context for visible replay versus ambiguity-preserving reconstruction.",
    },
    {
        "id": "openhands-doc-condenser-architecture",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/arch/condenser.md",
        "capture_method": "markdown",
        "tags": ["omitted-range", "summary-contradiction", "summary-flattening"],
        "notes": "Public architecture documentation describes history condensation, summaries, and omitted event references relevant to contradiction-preserving compression review.",
    },
    {
        "id": "openhands-doc-conversation-architecture",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/arch/conversation.md",
        "capture_method": "markdown",
        "tags": ["event-lineage", "source-authority", "temporal-contradiction"],
        "notes": "Public architecture documentation describes conversation state, event logs, persistence, and execution status relevant to temporal contradiction and authority preservation.",
    },
    {
        "id": "openhands-doc-events-architecture",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/arch/events.md",
        "capture_method": "markdown",
        "tags": ["contradiction-replay", "event-lineage", "source-authority"],
        "notes": "Public architecture documentation describes typed events and action/observation flows relevant to source authority and contradiction replay lineage.",
    },
    {
        "id": "shared-rrweb-readme",
        "system": "Shared",
        ...
        "capture_method": "markdown",
        "tags": ["replay-ambiguity", "visible-replay"],
        "notes": "Public upstream replay library documentation is included only as shared context for visible replay semantics.",
    },
]

PROOF_006_SOURCES: list[dict[str, Any]] = [
    {
        "id": "openclaw-doc-compaction",
        "system": "OpenClaw",
        "type": "doc",
        ...
        "fetch_url": "https://docs.openclaw.ai/concepts/compaction.md",
        "capture_method": "markdown",
        "tags": ["memory-promotion", "summary-authority", "temporal-validity"],
        "notes": "Public documentation describes compaction, successor transcript, and memory-flush surfaces relevant to authority preservation review.",
    },
    {
        "id": "openclaw-doc-memory-overview",
        "system": "OpenClaw",
        ...
        "fetch_url": "https://docs.openclaw.ai/concepts/memory.md",
        "capture_method": "markdown",
        "tags": ["memory-promotion", "source-authority", "stale-belief", "supersession"],
        "notes": "Public documentation describes memory files, action-sensitive memory boundaries, recall surfaces, and promotion/review lanes relevant to memory authority.",
    },
    {
        "id": "openclaw-doc-trajectory-bundles",
        "system": "OpenClaw",
        ...
        "fetch_url": "https://docs.openclaw.ai/tools/trajectory.md",
        "capture_method": "markdown",
        "tags": ["authority-lineage", "replay-authority", "temporal-validity"],
        "notes": "Public documentation describes trajectory export surfaces relevant to replay provenance and authority lineage review.",
    },
    {
        "id": "openhands-doc-agent-server-architecture",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/arch/agent-server.md",
        "capture_method": "markdown",
        "tags": ["operational-truth", "recovery-path", "runtime-provenance"],
        "notes": "Public architecture documentation describes remote execution and workspace surfaces relevant to operational truth and recovery boundaries.",
    },
    {
        "id": "openhands-doc-browser-session-recording",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/guides/browser-session-recording.md",
        "capture_method": "markdown",
        "tags": ["replay-authority", "visible-replay"],
        "notes": "Public documentation describes browser recording and replay support used as context for visible replay authority limits.",
    },
    {
        "id": "openhands-doc-condenser-architecture",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/arch/condenser.md",
        "capture_method": "markdown",
        "tags": ["omitted-range", "summary-authority", "supersession"],
        "notes": "Public architecture documentation describes history compression, summaries, forgotten event IDs, and condensed views relevant to summary authority review.",
    },
    {
        "id": "openhands-doc-conversation-architecture",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/arch/conversation.md",
        "capture_method": "markdown",
        "tags": ["event-lineage", "memory-persistence", "temporal-validity"],
        "notes": "Public architecture documentation describes conversation state, event logs, persistence, and execution status relevant to authority continuity.",
    },
    {
        "id": "openhands-doc-events-architecture",
        "system": "OpenHands",
        ...
        "fetch_url": "https://docs.openhands.dev/sdk/arch/events.md",
        "capture_method": "markdown",
        "tags": ["authority-lineage", "event-lineage", "source-authority"],
        "notes": "Public architecture documentation describes typed events and action/observation flows relevant to source authority and replay lineage.",
    },
    {
        "id": "openhands-issue-14287",
        "system": "OpenHands",
        ...
        "fetch_url": "https://api.github.com/repos/OpenHands/OpenHands/issues/14287",
        "capture_method": "github_issue",
        "tags": ["memory-recall", "recall-authority", "source-authority"],
        "notes": "Public issue report describes a recall action transcript interaction; included as reported evidence only, not an independent target-system finding.",
    },
    {
        "id": "shared-rrweb-readme",
        "system": "Shared",
...
PROOF_CONFIGS: dict[str, dict[str, Any]] = {
    ...
    "004-operational-failure-reconstruction": {
        "internal_consult_path": ROOT / "internal" / "inside_voice" / "proof_004_mcp_consult_response.json",
        "sources": PROOF_004_SOURCES,
    },
    "005-contradiction-survivability-audit": {
        "internal_consult_path": ROOT / "internal" / "inside_voice" / "proof_005_mcp_consult_response.json",
        "sources": PROOF_005_SOURCES,
    },
    "006-memory-authority-survivability-audit": {
        "internal_consult_path": ROOT / "internal" / "inside_voice" / "proof_006_mcp_consult_response.json",
        "sources": PROOF_006_SOURCES,
    },
}
